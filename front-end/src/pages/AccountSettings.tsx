    ...
    <div className="flex min-h-screen flex-col bg-white max-w-[430px] mx-auto shadow-xl">
      ...
      <main className="flex-1 overflow-y-auto pb-10">
        ...
        <div className="flex flex-col items-center gap-4 p-6 animate-slide-up">
          <div className="relative group">
            <div className="w-28 h-28 rounded-full overflow-hidden border-4 border-white shadow-[0_4px_24px_-4px_rgb(37_99_235/0.20)] ring-4 ring-blue-600/10 transition-all duration-300 hover:ring-blue-600/20">
              <img src={AVATAR_URL} alt="Foto de perfil" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-[1.05]" />
            </div>
            <button className="absolute bottom-0 right-0 bg-blue-600 text-white p-1.5 rounded-full shadow-md border-2 border-white transition-all duration-200 hover:scale-110 active:scale-95" aria-label="Editar foto de perfil">
              <User size={16} />
            </button>
          </div>
        ...
        <div className="px-6 py-8 mt-4">
          <button className="w-full flex items-center justify-center gap-2 bg-red-50 text-red-600 py-4 rounded-2xl font-bold border border-red-100 active:scale-95 transition-all duration-200 hover:bg-red-100 hover:border-red-200 hover:shadow-sm">
            <LogOut size={20} />
            Sair da Conta
          </button>
