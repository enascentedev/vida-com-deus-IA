  ...
  return (
    <section className="bg-gradient-to-br from-green-50 to-white py-12 px-6">
      <div className="max-w-7xl mx-auto flex flex-col items-center justify-center text-center gap-8 min-h-[500px]">
        <div className="relative w-full max-w-lg aspect-video rounded-2xl overflow-hidden shadow-2xl shadow-blue-500/10 group">
          <img
            src={HERO_IMAGE}
        ...
        <div className="flex flex-col gap-3 w-full max-w-sm">
          <button
            ...
            className="flex items-center justify-center h-14 rounded-xl bg-blue-600 text-white text-base font-bold shadow-[0_4px_20px_-4px_rgb(37_99_235/0.40)] hover:bg-blue-700 hover:shadow-[0_8px_28px_-4px_rgb(37_99_235/0.50)] transition-all duration-200 active:scale-[0.98]"
          >
            Criar Conta
          </button>
          <button
            ...
            className="flex items-center justify-center h-14 rounded-xl bg-slate-200 text-slate-900 text-base font-bold hover:bg-slate-300 transition-all duration-200 active:scale-[0.98]"
          >
            Saiba Mais
          </button>
        </div>
...
function FeatureCard({ icon, title, description }: FeatureCardProps) {
  return (
    <div className="bg-slate-50 p-8 rounded-2xl border border-slate-100 flex flex-col items-center text-center group hover:border-blue-500/40 hover:-translate-y-1.5 hover:shadow-[0_8px_32px_-4px_rgb(37_99_235/0.12)] transition-all duration-300">
      <div className="w-16 h-16 bg-blue-600/10 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-blue-600 transition-all duration-300">
